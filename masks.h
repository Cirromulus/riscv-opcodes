...
DECLARE_INSN(settaint_i, MATCH_SETTAINT_I, MASK_SETTAINT_I)
DECLARE_INSN(settaint_r, MATCH_SETTAINT_R, MASK_SETTAINT_R)
DECLARE_INSN(gettaint, MATCH_GETTAINT, MASK_GETTAINT)
